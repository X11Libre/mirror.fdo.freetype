...
#include "ftsmerrs.h"
  ...
  /* This function applies horizontal filter in direct rendering mode */
  static void
  ft_smooth_lcd_spans( int             y,
                       int             count,
                       const FT_Span*  spans,
                        ...
                        FT_Bitmap*   bitmap )
  {
    ...
    if ( render->root.library->lcd_weights[2] != 255 )
    {
  ...
  /* This function applies vertical filter in direct rendering mode */
  static void
